...
notes: |
  ...
  } elseif ($journeyFailed) {
    'Сквозные сценарии продукта (Фаза J) КРАСНЫЕ: свой сценарий задачи не проходит — см. remediation.'
  } else {
    'Сквозные сценарии продукта (Фаза J) красные у ЧУЖИХ задач, на этот вердикт не влияют.
  Чинить их в этой задаче нельзя: файлы сценариев вне её секции «Файлы».'
  })
